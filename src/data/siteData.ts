...
export const services: Service[] = [
  { title: 'Refrigerator Repair',   from: 'From $89', photo: '/images/hero/hero-technician.webp',            pos: '18% 45%', desc: 'Compressor failure, ice maker, water dispenser, cooling issues — OEM parts for every major brand, fixed on the first visit.'     },
  { title: 'Washer & Dryer Repair', from: 'From $79', photo: '/images/services/washer-dryer-repair.webp', pos: '8% 50%',  desc: "Won't drain, won't spin, won't heat. Same-day laundry room rescue anywhere in the Charlotte metro."                            },
  { title: 'Dishwasher Repair',     from: 'From $79', photo: '/images/services/dishwasher-repair.webp', pos: '50% 72%', desc: "Leaking, leaving dishes dirty, or won't start. Fast same-day diagnosis with a repair guaranteed to last."                      },
  { title: 'Oven & Range Repair',   from: 'From $89', photo: '/images/services/oven-range-repair.webp',        pos: '50% 60%', desc: "Burners, igniters, temperature sensors, control boards. Gas or electric — if it cooks, we fix it."                              },
  { title: 'Microwave Repair',      from: 'From $69', photo: '/images/services/microwave-repair.webp',  pos: '50% 28%', desc: 'Not heating, turntable stuck, or dead display. Built-in or countertop. Most jobs done in under 60 minutes.'                     },
  { title: 'Emergency Service',     from: 'Priority', photo: '/images/services/emergency-repair-tech.webp',     pos: '50% 18%', desc: "Appliance emergency? Priority dispatch across the Charlotte metro. Day or night, weekday or weekend — we'll be there."          },
];
