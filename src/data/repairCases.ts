...
export const repairCases: RepairCase[] = [
  {
    ...
    metaDesc: 'HomeHeroes repaired a Samsung French Door refrigerator with frost buildup and cooling failure in Ballantyne, Charlotte NC. Diagnosis, cost breakdown, and outcome.',
...

  {
    ...
    metaDesc: 'HomeHeroes replaced a failed drain pump on an LG front-load washer in South End, Charlotte NC. OE error code diagnosed and full function restored same day.',
...

  {
    ...
    metaDesc: 'HomeHeroes fixed a GE side-by-side refrigerator leaking onto the kitchen floor in Dilworth, Charlotte NC. Clogged drain line and cracked fill tube resolved same day.',
...

  {
    ...
    metaDesc: 'HomeHeroes repaired a Whirlpool top-load washer shaking violently in NoDa, Charlotte NC. Worn suspension rods and out-of-balance drum corrected same day.',
...

  {
    ...
    metaDesc: 'HomeHeroes repaired a Sub-Zero built-in refrigerator ice maker in Ballantyne, Charlotte NC. Water inlet valve replaced and filter changed. Ice restored same day.',
